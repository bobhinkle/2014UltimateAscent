...
public class Constants {
    ...
    public static final int autonSelect = 1;
    ...
    public static final double WRIST_X_SHOT = 43 + WRIST_HORIZONTAL_CAL + WRIST_OFFSET; // X Shot (Back/White Shot) 45
    public static final double WRIST_Y_SHOT = 44.0 + WRIST_HORIZONTAL_CAL + WRIST_OFFSET; //Y Shot (Middle Shot) 55
    public static final double WRIST_B_SHOT  = 50 + WRIST_HORIZONTAL_CAL + WRIST_OFFSET; //B Shot (Front Shot) //60
    public static final double WRIST_X_SHOT_ELE_UP = 40.5 + WRIST_HORIZONTAL_CAL + WRIST_OFFSET; //X Shot with Elevator 38.25
    public static final double WRIST_Y_SHOT_ELE_UP = 37.0 + WRIST_HORIZONTAL_CAL + WRIST_OFFSET;//Y Shot with Elevator
    ...
    public static final double DRIVE_DISTANCE_PER_PULSE = (72.0/4006.0)*2;      //0.03420833;  0.0173135189727312
