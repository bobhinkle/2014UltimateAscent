...
public class FSM {
    ...
    public final static int INTAKE_IN = 119;
    public final static int INTAKE_OUT = 120;
    public final static int INTAKE_DOWN = 121;
    public final static int INTAKE_UP = 122;
