...
public class Team1323Main extends SimpleRobot {
    ...
    public void autonomous() {
        //Select Auton Mode Here Moved to Constants.java
        ...
        robot.dt.highGear();
        double timer_firstshot = .15;
        double timer_secondshot = 1.0;
        double timer_ball_pulldown = 2.5;
        int counts = 0;
        ...
        switch(Constants.autonSelect){
            case 0:
                ...
                driveDistanceHoldingHeading(75, 0, 0.95, 5.0, 5.0, false, 0);
            ...
            case 1:
                fsm.setGoalState(FSM.SHOOTING2_ELE_UP);
                driveDistanceHoldingHeading(90, 0, 0.88, 4.0, 3, true, 0); //120,0,0.8,4.0,3,true,0
                Timer.delay(3.0);
                while(!dist.onTarget() && isAutonomous());
                robot.dt.directDrive(-0.5, 0.5);
                Timer.delay(0.2);
            ...
            case 3:
                ...
                System.out.println("1");
                //Distance - Heading - Max Speed - Timout - Tolerance      
                driveDistanceHoldingHeading(20, 0, 0.95, 0.75, 2.0, true, 0);
                System.out.println("2");
                fsm.setGoalState(FSM.SHOOTING2);
                driveDistanceHoldingHeading(100 , 0, 0.85, 2.75 , 2.0, false, 0); //75
                //Fire FIRST Shot
                counts = 0;
                while(!turn.onTarget() && isAutonomous() && counts < (timer_firstshot/0.01)){
                    Timer.delay(0.01);
                ...
                break;
            case 4:
                driveDistanceHoldingHeading(-144, 0, 0.95, 0.75, 2.0, true, 0);
                fsm.setGoalState(FSM.PICK_UP);
                fsm.setGoalState(FSM.SHOOTING2);
                break;
            case 5:
