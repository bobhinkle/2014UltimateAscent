...
public class Constants {
    ...
    public static final double WRIST_Y_SHOT = 45.0 + WRIST_HORIZONTAL_CAL + WRIST_OFFSET; //Y Shot (Middle Shot) 55
    ...
    public static final double WRIST_Y_SHOT_ELE_UP = 43.5 + WRIST_HORIZONTAL_CAL + WRIST_OFFSET;//Y Shot with Elevator
