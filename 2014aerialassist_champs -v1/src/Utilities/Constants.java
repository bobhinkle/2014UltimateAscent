...
public class Constants {
    ...
    public static final double DIST_KP_2BALL = 0.018;
    public static final double DIST_KI_2BALL = 0.00; 
    public static final double DIST_KD_2BALL = 0.00;
    ...
    public static final double WRIST_LIGHT_TOLERANCE = 2.5;
    public static final double WRIST_MIN_ANGLE = 90;
    public static final double WRIST_MAX_ANGLE = 75 + WRIST_MIN_ANGLE;
    public static final double WRIST_P_UP = 0.024;     //.0254
    public static final double WRIST_I_UP = 0.00023;    //.00023
    public static final double WRIST_D_UP = 0.01;       //.01
    public static final double WRIST_P_DOWN = 0.024;    //.025
    public static final double WRIST_I_DOWN = 0.00023;  //.00023
    public static final double WRIST_D_DOWN = 0.01;     //.01
    public static final double WRIST_MAX_POWER = 1.0;
    public static final double WRIST_LOADING_POS = 3 + WRIST_MIN_ANGLE;
    public static final double WRIST_X_SHOT = 45 + WRIST_MIN_ANGLE + WRIST_OFFSET; // X Shot (Back/White Shot) 45
    public static final double WRIST_Y_SHOT = 55 + WRIST_MIN_ANGLE + WRIST_OFFSET; //Y Shot (Middle Shot) 55
    public static final double WRIST_B_SHOT  = 65 + WRIST_MIN_ANGLE + WRIST_OFFSET; //B Shot (Front Shot) //60
    public static final double WRIST_X_SHOT_ELE_UP = 45 + WRIST_MIN_ANGLE + WRIST_OFFSET; //X Shot with Elevator 38.25
    public static final double WRIST_Y_SHOT_ELE_UP = 51 + WRIST_MIN_ANGLE + WRIST_OFFSET;//Y Shot with Elevator
    public static final double WRIST_B_SHOT_ELE_UP  = 65 + WRIST_MIN_ANGLE + WRIST_OFFSET;//B Shot with Elevator 63
    public static final double WRIST_HORIZONTAL = 22 + WRIST_MIN_ANGLE;
    ...
    public static final double ELEVATOR_DOWN_P = 0.015; //0.003
