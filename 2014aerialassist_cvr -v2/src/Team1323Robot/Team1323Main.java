...
public class Team1323Main extends SimpleRobot {
    ...
    public void autonomous() {
        ...
        switch(autonSelect){
            case 0:
                ...
                driveDistanceHoldingHeading(95, 0, 0.95, 6.0, 5.0, false, 0);
    ...
    public void turnToHotGoal(int hotGoal){
        double angleToLeftGoal = -35;
        double angleToRightGoal = 35;
        switch(hotGoal){
            case Constants.LEFT_GOAL:
                turnToHeading(angleToLeftGoal, 1.5);
                break;
            case Constants.RIGHT_GOAL:
                turnToHeading(angleToRightGoal, 1.5);
                break;
        }
    }
}
